...
function hydrateFactory($stencilWindow, $stencilHydrateOpts, $stencilHydrateResults, $stencilAfterHydrate, $stencilHydrateResolve) {
  ...
  function hydrateAppClosure($stencilWindow) {
    ...
    const NAMESPACE = 'stencilssr';
    const BUILD = /* stencilssr */ { hydratedSelectorName: 'hydrated', slotRelocation: true, updatable: true, watchCallback: false };
 ...
 */
    ...
    var createElm = (oldParentVNode, newParentVNode, childIndex) => {
      ...
      if (newVNode2.$text$ !== null) {
        ...
        elm = newVNode2.$elm$ = win.document.createElement(!useNativeShadowDom && BUILD.slotRelocation && newVNode2.$flags$ & 2 /* isSlotFallback */ ? 'slot-fb' : newVNode2.$tag$);
        {
          updateElement(null, newVNode2);
        }
    ...
    var originalLocationDebugNode = nodeToRelocate => {
      ...
      return (_a = win.document) == null
        ? void 0
        : _a.createComment(`org-location for ` + (nodeToRelocate.localName ? `<${nodeToRelocate.localName}> (host=${nodeToRelocate['s-hn']})` : `[${nodeToRelocate.textContent}]`));
    };
    ...
    var NO_HYDRATE_TAGS = /* @__PURE__ */ new Set(['CODE', 'HEAD', 'IFRAME', 'INPUT', 'OBJECT', 'OUTPUT', 'NOSCRIPT', 'PRE', 'SCRIPT', 'SELECT', 'STYLE', 'TEMPLATE', 'TEXTAREA']);
...
var Tokenizer = class {
  ...
  _isCharacterReferenceInAttribute() {
    return (
      this.returnState === State.ATTRIBUTE_VALUE_DOUBLE_QUOTED || this.returnState === State.ATTRIBUTE_VALUE_SINGLE_QUOTED || this.returnState === State.ATTRIBUTE_VALUE_UNQUOTED
    );
  }
    ...
    if (EMPTY_ELEMENTS.has(tagName) === false) {
      ...
      if (shadowRoot != null && opts.serializeShadowRoot !== false) {
        ...
        if (
          opts.newLines &&
          (childNodes.length === 0 ||
            (childNodes.length === 1 && childNodes[0].nodeType === 3 /* TEXT_NODE */ && ((_e = childNodes[0].nodeValue) == null ? void 0 : _e.trim()) === ''))
        ) {
          yield '\n';
          output.currentLineWidth = 0;
          for (let i = 0; i < output.indent; i++) {
...
var MockSlotElement = class _MockSlotElement extends MockHTMLElement {
  ...
  assignedNodes(opts) {
    ...
    if (ownerHost.childNodes.length) {
      if (this.name) {
        nodesToReturn = ownerHost.childNodes.filter(n => n.nodeType === 1 /* ELEMENT_NODE */ && n.getAttribute('slot') === this.name);
      } else {
        nodesToReturn = ownerHost.childNodes.filter(n => (n.nodeType === 1 /* ELEMENT_NODE */ && !n.getAttribute('slot')) || n.nodeType !== 1 /* ELEMENT_NODE */);
      }
